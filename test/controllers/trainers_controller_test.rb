...
class TrainersControllerTest < ActionController::TestCase
  ...
  test "should create trainer" do
    assert_difference('Trainer.count') do
      post :create, trainer: { cell_number: @trainer.cell_number, first_name: @trainer.first_name, group_id: @trainer.group_id, password: @trainer.password }
    end
  ...
  test "should update trainer" do
    patch :update, id: @trainer, trainer: { cell_number: @trainer.cell_number, first_name: @trainer.first_name, group_id: @trainer.group_id, password: @trainer.password }
    assert_redirected_to trainer_path(assigns(:trainer))
  end
